...
public class StudentManagerApp {
	public static void main(String[] args) {
		StudentManager manager = new StudentManager();//지금은 요소에 아무것도 없음
		...
		System.out.println("=====================================================================");
		//저장매체에 저장된 학생정보 중 학번이 2000인 학생의 이름을 임걱정으로 변경하는 메소드 호출
		...
		System.out.println("=====================================================================");
		//저장매체에 저장된 학생정보 중 학번이 4000인 학생정보를 삭제하는 메소드 호출
