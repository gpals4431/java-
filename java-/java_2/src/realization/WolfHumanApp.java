...
public class WolfHumanApp {
   public static void main(String[] args) {
      ...
      //부모 클래스로 참조변수를 생성하여 자식 클래스의 객체 저장
      // => 참조변수는 기본적으로 부모클래스의 메소드만 호출가능
      ...
      //인터페이스(부모)로 참조변수를 생성하여 자식 클래스의 객체를 저장 가능
      //Wolf wolf = new WolfHuman();>>새로운 객체 기존이 것과 다름
      
      //자식클래스가 같은 클래스와 인터페이스는 명시적 객체 형변환을 이용하여 자식클래스의
      //객체를 공유하여 사용이 가능하다.
      Wolf wolf=(Wolf)human;//>>>★★★★부모끼리는 자식을 공유해서 쓸 수 있다
