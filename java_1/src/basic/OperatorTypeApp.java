...
public class OperatorTypeApp {
	public static void main(String[] args) {
		...
		// => ~ : Bit Not연산자(1의 보수 연산자): 정수값으로 표현된 bit단위의 값을 반대로 변환하는 연산자
		// => ! : Not 연산자 : f/t반대로 변환하는 연산자
		// => ++: 1증가 연산자: 피연산자를 변수로 설정하고 변수값을 1 증가하여 저장하는 연산자
		// => --: 1감소 연산자: 피연산자를 변수로 설정하고 변수값을 1 감소하여 저장하는 연산자
		...
		//
		// ++또는 --연산자로만 구성된 단일 명령이 아닌 경우 연산자의 위치는 연산결과에 영향
		int result1 = ++a4;// 전처리:++a4 명령 연산식이 실행된 후 result1=a4 연산식 실행
		int result2 = a5++;// 후처리:result2=a5 연산식이 실행된 후 a5++연산자 실행
		System.out.println("a4=" + a4 + ", a5=" + a5);
		...
		//대입 연산자 : 왼쪽 피연산자(변수)에 값을 저장하기 위한 연산자
				...
				//    - *=, /=, %=, +=, -=, <<=, >>=, >>>=, &=, ^=, |=
		int e=10;
		System.out.println("e="+e);//순수 대입 연산자
