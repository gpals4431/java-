...
//리터럴(literal):프로그램에서 값을 표현되는 값(Value)
//변수(Variable): 리터럴(=값)을 저장하기 위해 메모리(주기억 장치)에 부여된 이름
...
public class VariableApp {
	public static void main(String[] args) {
		...
		su=100;//=(대입연산자):저장하다(오른쪽에서 왼쪽으로 읽음)-입력, ==:같다, 변수는 왼쪽, 값은 오른쪽에 작성
		System.out.print("초기값=");
		System.out.println(su);//변수에 저장된 값을 화면에 출력
	
		//int su;//동일한 이름의 변수를 재선언할 경우 에러 발생
		su=200;//변수는 값을 하나만 저장할 수 있음, 변수에 기존값 대신 새로운 값 저장.
		...
		//"문자열"+값 또는 값+"문자열">> 문자열과 값이 결합 - 결과값은 문자열
		...
		System.out.println("2023"+"년은 토끼띠해입니다.");
		System.out.println("=========================================================");
		...
		System.out.println("연산결과="+num1*num2);
		System.out.println("연산결과="+(num1*num2));//조금 더 효율적인 방법, ()=최우선 연산자-가독성이 더 좋음.
		System.out.println("=========================================================");
		int kor=88, eng=90;
