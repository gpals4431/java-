...
public class DoubleArrayApp {
	public static void main(String[] args) {
		...
		int[][] num = new int [2][3];
			...
			System.out.println("==========================================");
			// 1차원 배열의 요소의 갯수가 정해져 있지 않은 2차원 배열 선언 // 메모리 주소만 저장하고 실제 2차원 배열은 만들어지지 않음
			// => 1차원 배열의 메모리주소를 저장하는 참조요소만 생성되고 1차원 배열은 미생성
			...
			System.out.println("==========================================");
			//2차원 배열의 참조요소에 1차원 배열을 생성하여 메모리 주소를 저장 
			// => 1차원 배열의 요소의 갯수를 다르게 생성하여 저장 가능 - 가변 배열 > 메모리를 절약하기 위해 사용
			value[0]=new int[3];
			value[1]=new int[2];
			value[2]=new int[4];
