...
public class FrameTwoApp extends Frame {
	...
	public FrameTwoApp(String title) {
		super(title);//frame(String title) 생성자를 이용하여 frame 객체 생성 초기값의 제목은 super사용
		
		//setTitle(title): 프레임의 제목을 변경하는 메소드
		//setTitle(title);
		//component.setBounds(int x, int y, int width, int height): 컴퍼넌트의 출력 위치와 크기를
		//변경하는 메소드 
		setBounds(600,100,400,300);//setSize+setLocation 두개를 쓴것과 같은 효과
