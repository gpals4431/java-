...
public class StatementApp {
	public static void main(String[] args) throws Exception {
		...
		String sql1="insert into student values("
				+no+",'"+name+"','"+phone+"','"+address+"','"+birthday+"')";//자바 변수값과 오라클 변수값을 함께 작성 > 자바 변수(문자값) 작성: ' "+__+" '
		...
		*/
		...
		String sql1="select * from student where name ='"+name+"'order by no";//값에 ' or '1'='1 입력시 무조건 참인 sql명령이 입력되어 전부 출력
