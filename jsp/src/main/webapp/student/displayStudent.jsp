...
<body>
	...
	<table align="center" border="1" cellspacing="0" cellpadding="1" width="800">
		...
		<% for(StudentDTO student:studentList){ %>
			...
			<td width="50"><input type="button" value="삭제" onclick="removeConfirm(<%=student.getNo()%>);"></td><!-- getNo:studentDTo에 저장된 no -->			
			<td width="50"><input type="button" value="변경" onclick="location.href='updateFormStudent.jsp?no=<%=student.getNo()%>';"></td>				
		</tr>	
		<% } %>
	</table>
	<script type="text/javascript">
	function removeConfirm(no) {//deletestudent의 request 매개변수값으로 전달 -> deletestudent.jsp에서 삭제처리
