...
<body>
	...
	<img src="/spring/images/Koalang.jpeg" width="200">
	...
	<img src="${pageContext.request.contextPath }/images/Koalang.jpeg" width="200">
	
	<%-- core 태그 라이브러리의 url 태그를 사용하여 컨텍스트 경로를 제공받아 사용 --%>
	<img src="<c:url value="/images/Koalang.jpeg"/>" width="200">

	<%-- spring 태그 라이브러리의 url 태그를 사용하여 컨텍스트 경로를 제공받아 사용 --%>
	<img src="<spring:url value="/images/Koalang.jpeg"/>" width="200">
</body>
</html>
